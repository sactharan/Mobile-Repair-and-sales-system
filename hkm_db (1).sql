...
(1, '2023-05-04', 'Suman', 'Talawakelle', '0778844224', 1350, 1500, -150, 0, '0', '3', '2023-05-04'),
(2, '2023-05-04', 'Manohar', 'watagoda', '0512236014', 1100, 1000, 0, 0, '0', '3', '2023-05-08'),
(5, '2023-05-04', 'sambar', 'paniyakanaku', '2352542545', 700, 700, 0, 0, '0', '3', '2023-05-04'),
(7, '2023-05-08', 'sasi tharan', 'no. 17', '0778720065', 3250, 3250, 0, 0, '0', '3', '2023-05-08');
...
INSERT INTO `products` (`id`, `purchase_id`, `product_code`, `product_name`, `qty`, `unit_price`, `total`, `status`) VALUES
(1, 0, 'Item_001', 'Toys', 12, 250, 0, '1'),
(3, 0, 'item_002', 'Tempered', 120, 450, 0, '1'),
(4, 0, 'item_003', 'Backcover Huwaei', 85, 650, 0, '1'),
(5, 0, 'item_004', 'Handsfree normal', 25, 650, 0, '1'),
(6, 0, 'Item_005', 'Samsung a30 Display', 3, 6500, 0, '1'),
(7, 0, 'item_006', 'nokia 106 charger pin', 12, 450, 0, '1'),
(8, 0, 'item_007', 'Nokia Battery b4', 24, 850, 0, '1'),
(9, 0, 'Item_008', 'huwaei sim tray', 6, 1250, 0, '1'),
(10, 0, 'item_0010', 'Battery huwaei', 12, 250, 0, '1'),
(11, 2, '', 'fff', 677, 56, 37912, ''),
(12, 3, '', 'ccc', 45, 567, 25515, '1'),
(13, 4, '', 'fff', 567, 45, 25515, '1'),
(14, 4, '', 'kkk', 78, 78, 6084, '1'),
(15, 5, 'Item_100', 'ccc', 450, 56, 25200, '1'),
(16, 6, '', 'ccc', 450, 56, 25200, '1'),
(17, 7, '', 'nokia display 106', 650, 12, 7800, '1'),
(18, 7, '', 'nokia battery b4', 800, 6, 4800, '1');
...
CREATE TABLE `purchases` (
  ...
  `existing_supplier` varchar(255) NOT NULL,
...
INSERT INTO `purchases` (`id`, `p_date`, `type`, `existing_supplier`, `suppliername`, `total_cost`, `amt_paid`, `balance`, `payment`) VALUES
(5, '2023-06-01', '0', '3 Touch', '3 Touch', 25200, 24000, 1200, 0),
(7, '2023-05-22', '0', 'Btec', 'Btec', 12600, 12600, 0, 1);
...
INSERT INTO `suppliers` (`id`, `supplier_code`, `supplier_name`, `supplier_contact`, `supplier_address`, `status`) VALUES
(1, 'sup-001', 'trans asia', '0770154626', 'colombo', '1'),
(3, 'sup-002', 'Toy Lanka', '0770154626', 'colombo', '1'),
(4, 'sup-003', 'Kandy Lanka', '0770152646', 'Kandy', '1'),
(5, 'sup-008', 'Mobile tec', '0774419169', 'Colombo pettah', '1'),
(6, 'sup-009', 'Toys Lanka', '0774419169', 'Colombo pettah', '1'),
(7, 'sup-010', 'Bag lanka', '0774419169', 'Colombo pettah', '1'),
(8, 'sup-011', 'Redmi Shop', '0774419169', 'Colombo pettah', '1'),
(9, 'sup-012', 'FarmHouse', '0774419169', 'Nittambuwa', '1'),
(10, 'sup-013', 'One Touch', '0774419169', 'Watagoda Town', '1'),
(11, 'sup-013', '3 Touch', '0774419169', 'Hatton', '1'),
(12, 'sup-014', 'Regals', '0774419169', 'Hatton', '1'),
(13, 'sup-019', 'Sugunas', '0774419169', 'Kandy', '1'),
(14, 'sup-020', 'Btec', '0774419169', 'TK', '1'),
(15, 'sup-021', 'Mobile techno', '0774419169', 'Kandy', '1'),
(16, 'sup-023', 'cc', '0774419169', 'ssdd', '1'),
(17, 'sup-01455', 'sdfdsf', 'dsfdsf', 'dfdsf', '1'),
(18, 'sup-0034', 'dsfdsf', 'fdsfdsf', 'sdfdsfdsff', '1'),
(19, 'sup-00555', 'trans asiacc', 'xc', 'xvxv', '1');
