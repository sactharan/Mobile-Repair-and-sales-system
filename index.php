      ...
      <div class="full counter_section margin_bottom_30">
         ...
         <div class="counter_no">
            <div>
               ...
               <p class="head_couter">Total purchases Invoice</p>
            </div>
         </div>
      </div>
   </div>
      ...
      <div class="full counter_section margin_bottom_30">
         ...
         <div class="counter_no">
            <div>
               ...
               <p class="head_couter">Total Purchases</p>
            </div>
         </div>
      </div>
   </div>
         ...
         <div class="counter_no">
            <div>
               <p class="total_no">
                  ...
                  $query = "SELECT sum(amt_paid) as total FROM purchases";
         ...
         <div class="counter_no">
            <div>
               <p class="total_no">
                  ...
                  $query = "SELECT sum(balance) as total FROM purchases";
