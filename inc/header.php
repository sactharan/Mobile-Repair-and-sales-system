            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <h4>Servcies and Products</h4>
                     ...
                     <li><a href="purchaseslist.php"><i class="fa fa-clock-o orange_color"></i> <span>Purchases List</span></a></li>  
                      <!-- <li><a href="purchases.php"><i class="fa fa-clock-o orange_color"></i> <span>Product Purchases</span></a></li>   -->
                     <li><a href="suppliers.php"><i class="fa fa-clock-o orange_color"></i> <span>Suppliers</span></a></li>  
                     <h4>Reports</h4>
                     <li><a href="reports.php"><i class="fa fa-clock-o orange_color"></i> <span>Sales Reports</span></a></li>
                     <li><a href="purchase_reports.php"><i class="fa fa-clock-o orange_color"></i> <span>Purchase Reports</span></a></li>
                     <li><a href="repair_reports.php"><i class="fa fa-clock-o orange_color"></i> <span>Mobile Repair Reports</span></a></li>
                  </ul>
               </div>
            </nav>
            <!-- end sidebar -->
